                                ...
                                featured.map((post,index) =>
                                    (
                                            <div className={index === 0 ? "carousel-item active":"carousel-item"} >
                                                <img src={"/images/blogs/resized/"+post.image} style={{height:"200px", objectFit:"cover",background:'linear-gradient(0deg, black, transparent)'}} className="d-block w-100" alt="..."/>
